...
fix_ip() {
  ...
  wget -O /bin/check-update https://raw.githubusercontent.com/edusama79/LATAM_Oficial/main/Ejecutables/check-update &>/dev/null
  chmod +rwx /bin/check-update

  cd /etc
  wget https://raw.githubusercontent.com/edusama79/LATAM_Oficial/main/SCRIPT-LATAM.tar.gz >/dev/null 2>&1
